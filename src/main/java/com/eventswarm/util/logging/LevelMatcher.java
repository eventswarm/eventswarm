...
/**
 * Matches log events that have a level equal to the specified level
 *
...
public class LevelMatcher implements Matcher {
    ...
    private static Logger logger = Logger.getLogger(LevelMatcher.class);

    public LevelMatcher(LogEvent.Level level) {
