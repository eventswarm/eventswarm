 ...
 * User: andyb
 */
public class JdoCSVArrayEvent extends JdoEvent implements CSVEvent {
     ...
     */
    public JdoCSVArrayEvent(Header header, Map<String, Integer> fields, String[] values) {
    ...
    public JdoCSVArrayEvent setCompact(boolean compact) {
