...
/**
 * Interface for clients wishing to recieve notifications of expression matches caused by the delivery of a new event.
 *
 * See matching trigger interface for further semantic details.
 * 
 * @author andyb
 */
