 ...
 * or other predefined source of values (including static values)
 *
 * Created with IntelliJ IDEA.
 * User: andyb
 */
public class ValueGreaterMatcher implements Matcher {
    private Value<Number> value;
    private ValueRetriever<Number> retriever;

    public ValueGreaterMatcher(Value<Number> value, ValueRetriever<Number> retriever) {
        this.value = value;
        this.retriever = retriever;
    }

    /**
     * Returns true if the value in the event is greater than the value supplied in the constructor
     *
