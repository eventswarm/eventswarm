...
public class CSVArrayChannel extends AbstractChannel {
    ...
    protected static Logger logger = Logger.getLogger(CSVArrayChannel.class);
    private transient Map<String,Source> sourceCache;

    protected CSVArrayChannel() {
        super();
    }
     ...
     * @param istr
     */
    public CSVArrayChannel(InputStream istr) {
        this(istr, null, null);
    }
     ...
     */
    public CSVArrayChannel(InputStream istr, String fieldNames[]) {
     ...
     */
    public CSVArrayChannel(InputStream istr, Map<String,Integer> fieldMap) {
     ...
     *
     */
    public CSVArrayChannel(InputStream istr, String fieldNames[], Map<String,Integer> fieldMap) {
        super();
        this.istr = istr;
     ...
     * @return this
     */
    public CSVArrayChannel setSourceName(String sourceName) {
    ...
    protected CSVEvent createEvent(String values[]) throws ParseException {
        ...
        if (!defaultMap) {
            ...
            return new JdoCSVArrayEvent(header, fieldMap, eventValues);
        } else {
            return new JdoCSVArrayEvent(header, fieldMap, values);
        }
    }
    ...
    public CSVArrayChannel setFieldNames(String[] fieldNames) {
        this.fieldNames = fieldNames;
        return this;
    }

    public CSVArrayChannel setFieldMap(Map<String, Integer> fieldMap) {
        this.fieldMap = fieldMap;
        return this;
    }
     ...
     * @return this
     */
    public CSVArrayChannel setSourceField(String name) {
     ...
     * @return this
     */
    public CSVArrayChannel setTimestampField(String name, DateFormat timestampFormat) {
