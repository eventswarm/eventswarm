 ...
 * @author andyb
 */
public class EventScorePassThruFilter extends MutablePassThruImpl {

    private Scorer scorer;
    private int minimum;

    private EventScorePassThruFilter() {
        super();
    }
     ...
     * @param minimum
     */
    public EventScorePassThruFilter(Scorer scorer, int minimum) {
        super();
    ...
    public void execute(AddEventTrigger trigger, Event event) {
        if (this.scorer.score(event) < this.minimum) {
