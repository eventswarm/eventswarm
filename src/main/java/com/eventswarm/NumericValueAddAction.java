...
/**
 * Action called in response to a NumericValueAddTrigger firing, called when an 
 * upstream computed abstraction updates a numeric value due to the addition of 
 * an event. 
 * 
