...
/**
 * Simple implementation of ActionExecutor that executes actions immediately (i.e. synchronously)
 *
 * This implementation is not thread safe, that is, it doesn't lock
 *
